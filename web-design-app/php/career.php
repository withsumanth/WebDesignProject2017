...
try {
    ...
    <p>You have recived an email from ".$data->name.". He has sent his discription and personnal details in the mail. His email id  is: ".$data->email." and phone number is: ".$data->phone." Person description is given below</p><h3>Message</h3><p>".$data->msg."</p>";
    $mail->send();
} catch (Exception $e) {
